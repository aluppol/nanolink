...
CHECKS: list[Check] = [
    ...
    ("user interface", "/", {}, 200, {"content-type": "text/html", "content-security-policy": "default-src 'self'"}),
    ("API without a token", "/api/me", {}, 401, {"www-authenticate": "Bearer"}),
    ("API with a forged token", "/api/me", {"X-Forwarded-Access-Token": "forged"}, 401, {}),
    ("seeded short link", "/Albert", {}, 302, {"location": "https://albert.luppol.com/", "cache-control": "no-store"}),
    ("seeded short link again, from the cache", "/Albert", {}, 302, {"location": "https://albert.luppol.com/"}),
    ("seeded short link for a browser", "/NanoGH", {"Accept": "text/html"}, 302,
     {"location": "https://github.com/aluppol/nanolink"}),
    ("unknown short link", "/zzzzzz", {}, 404, {"content-type": "application/json"}),
    ("unknown short link for a browser", "/zzzzzz", {"Accept": "text/html"}, 404, {"content-type": "text/html"}),
